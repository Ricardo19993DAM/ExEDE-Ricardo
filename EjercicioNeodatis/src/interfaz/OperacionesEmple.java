...
public class OperacionesEmple extends JDialog {
	private final class actionListenerModificar implements ActionListener {
	...
	private final class actionListenerBorrar implements ActionListener {
	...
	private final class actionListenerConsultar implements ActionListener {
	...
	private final class actionListenerInsertar implements ActionListener {
	...
	public OperacionesEmple() {
		...
		btnInsertar.addActionListener(new actionListenerInsertar());
		
		//Accion boton consultar
		btnConsultar.addActionListener(new actionListenerConsultar());
		
		//Accion boton borrar
		btnBorrar.addActionListener(new actionListenerBorrar());
		
		//Accion boton modificar
		btnModificar.addActionListener(new actionListenerModificar());
	}
}
